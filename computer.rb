...
class PlayerComp
    ...
    def win(player)
        ...
        def h_move(player)
            ...
            stupid = [[2,5,8]]
            wins_game = [[1,2,3],[7,4,1],[7,1,4],[9,7,8],[7,9,8],[1,3,2],[5,3,7],[3,6,9],[3,9,6],[9,6,3],[5,4,6],[5,6,4],[5,8,2],[9,3,6],[8,5,2],[6,5,4],[4,5,6],[7,8,9],[9,8,7],[8,9,7],[1,4,7],[5,2,8],[2,5,8],[1,5,9],[3,5,7],[1,7,4],[7,5,3],[6,7,8],[2,9,6],[8,1,4],[3,8,6],[4,6,2],[6,8,3],[3,7,6],[7,3,4],[1,8,4]]
